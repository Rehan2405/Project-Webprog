  ...
  <div class="text-white">
    ...
    <<div class="row">
            ...
            <div class="col-4 mb-4 order-1 mt-3">
              <div class="card">
              <img src="<?php echo e(url('/Images/' . $dest->image)); ?>" style="object-fit: :cover; width:100%; height:180px"  class="card-img-top" alt="image">
                  <div class="card-body">
                      ...
                      <a href="<?php echo e(url('detail/'. $dest->id)); ?>" class="btn btn-outline-info"> More Detail</a>
                  </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\edbert.hansel\Desktop\Project-Webprog\resources\views/home.blade.php ENDPATH**/ ?>