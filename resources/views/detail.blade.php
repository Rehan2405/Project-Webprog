    ...
    <div style="background-color: rgb(255, 255, 255)">
        <div class="container">
            ...
            <div class="mx-2 d-flex justify-content-center gap-3">
                <a href="/destination/update/{{ $destination->id }}" class="btn btn-primary mb-2">
                    Update
                </a>
                @if (isset($favourite))
            ...
            <div class="d-flex justify-content-center mb-5 mt-4">
                <a href="{{ $destination->video }}" target="_blank" class="w-75 border">
                    <img class="w-100" src="{{ 'https://img.youtube.com/vi/' . $thumbnail . '/maxresdefault.jpg' }}"
                        alt="">
            ...
            <div class="d-flex flex-column justify-content-center mb-5">
                <p class="text-justify" style="font-size: 20px">{{ $destination->desc }}
                    <br><br>
                    <img src="{{ asset('images/' . $destination->image) }}" class="w-100" style="height: 400px"
                        alt="...">
            ...
            <div class="d-flex">
                            ...
                            @foreach ($reviews as $item)
                                <div class="d-flex reviews m-1">
                                    ...
                                    @elseif($item->inputType == 'IMG')
                                        @if ($item->class == 'big')
                                            <img style="height:400px;width:1000px" src={{ $item->value }}
                                                class="{{ $item->class }}">
                                        @else
                ...
                <div class="mapouter w-100">
                    <div class="gmap_canvas">
                        <iframe width="500" height="500" id="gmap_canvas" src={{ $destination->location }}
